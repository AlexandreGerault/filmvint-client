...
const Movies = [
  {
    ...
    label: 'Voter',
    poster: 'https://m.media-amazon.com/images/M/MV5BMjEzMTU2MjY1M15BMl5BanBnXkFtZTYwODA5Nzg4._V1_FMjpg_UX337_.jpg',
    width: 337,
    height: 475,
  },
  {
...
export const metadata: Metadata = {
  ...
  description: 'Filmvint est une association fictive de diffusion de films anciens.',
};

export default async function Home() {
  return (
    <div className="flex flex-col px-4 py-4 lg:px-24 lg:pb-32">
      <div className="relative px-6 lg:px-8">
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-24">
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Filmvint</h1>
            <p className="mt-6 text-lg leading-8 text-gray-600" />
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Link href="/inscription" variant="primary-button">
                Devenir membre
              </Link>
      ...
      <div>
        ...
        <ul className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8">
          {Movies.map((movie) => (
            <MovieCard key={movie.title} type="link" actionProps={{ href: '#' }} {...movie} />
          ))}
        </ul>
      </div>
    </div>
